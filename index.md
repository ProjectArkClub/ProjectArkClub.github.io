...
- 优化弯刀使用体验
    - 弯刀闪退、卡死等异常情况自动重开弯刀（仅支持单开弯刀）
    - 解决弯刀的掉线重连功能可能导致的机器蓝屏问题
    - DMO 掉线重连自动开启无动作
- 自动截胡 Decode-II 扭蛋机，**仅限北美服奥区**
    - 功能：一键后台托管，支持断线重连
    - 出货率：dcode2:hbu5 出货率约为 1.2:1
    - 出货量：hbu5 每日出货量约为 60~100
- JJC 功能
    - 自动快速召唤至任意层， 普通 JJC 单票约节省 5 分钟
    - 指定层停止并转入 DATS 参与战斗
- 自动后台登录账号、断线重连，批量自动更新 DMO 客户端

## RPG
- 支持后台自动过验证、断线重连、变速、转盘、扭蛋、找怪、对战、上卡、补卡、捕捉、召唤、进化、自选捡物、恢复 evp、补buff、副宠复活进化、活动频道兑换
- 支持官服和私服
